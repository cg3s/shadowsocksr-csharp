...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        {
            Process.Start("https://github.com/cg3s/shadowsocks-rss/wiki");
        }

        private void FeedbackItem_Click(object sender, EventArgs e)
        {
            Process.Start("https://github.com/cg3s/forum/issues/new");
            //Process.Start("https://github.com/cg3s/shadowsocksr-csharp/issues/new");
        }
        ...
        {
            Process.Start("https://cg3s.github.io");
        }
        ...
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/cg3s/cg3s.github.io/master/ssr/ss_lanip.pac");
        }

        private void UpdatePACFromCNWhiteListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/cg3s/cg3s.github.io/master/ssr/ss_white.pac");
        }

        private void UpdatePACFromCNOnlyListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/cg3s/cg3s.github.io/master/ssr/ss_white_r.pac");
        }

        private void UpdatePACFromCNIPListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/cg3s/cg3s.github.io/master/ssr/ss_cnip.pac");
        }
